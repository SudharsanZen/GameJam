Shader "Custom/rimSHading2"
{
    Properties
    {
        ...
        _Size ("StripeCount", Range(0,10)) = 0.5
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutput o)
        {
			...
			o.Emission = ((frac(IN.uv_MainTex.y*_Size*10)>_StripeSize && frac(IN.uv_MainTex.x*_Size * 10) > _StripeSize)?_RimColor:a)*dotProd;
